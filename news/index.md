...
- Slightly better code generated for
  [`tweaks()`](https://dbitest.r-dbi.org/reference/tweaks.md)
...
- [`test_some()`](https://dbitest.r-dbi.org/reference/test_all.md) also
  tests a test if it would normally be skipped.
...
- [`tweaks()`](https://dbitest.r-dbi.org/reference/tweaks.md) gains
...
- [`test_some()`](https://dbitest.r-dbi.org/reference/test_all.md) shows
  DBI code via dblog
...
- `test_*()` gain new `run_only = NULL` argument that allow restricting
  ...
  [`test_some()`](https://dbitest.r-dbi.org/reference/test_all.md) uses
  `run_only` instead of constructing a regular expression with negative
  lookahead. This helps troubleshooting a single test with
...
- Allow running only a subset of tests in
  [`test_all()`](https://dbitest.r-dbi.org/reference/test_all.md) by
  specifying an environment variable.
- [`test_all()`](https://dbitest.r-dbi.org/reference/test_all.md) and
  [`test_some()`](https://dbitest.r-dbi.org/reference/test_all.md)
...
- New [`test_some()`](https://dbitest.r-dbi.org/reference/test_all.md)
...
- The arguments of the
  ...
  now have default values that further describe their intended usage.
...
- [`tweaks()`](https://dbitest.r-dbi.org/reference/tweaks.md) gains an
  `...` as first argument to support future/deprecated tweaks (with a
...
- New feature: tweaks
  ...
  - New [`tweaks()`](https://dbitest.r-dbi.org/reference/tweaks.md),
...
- Testing infrastructure
  ...
  - Function
    [`test_all()`](https://dbitest.r-dbi.org/reference/test_all.md) that
    runs all tests
- Tests from the proposal
  - Getting started
  - Driver
