...
[`dbSendQuery()`](https://dbi.r-dbi.org/reference/dbSendQuery.html) with
non-empty result set, `dbHasCompleted()` returns `FALSE` initially and
`TRUE` after calling
[`dbFetch()`](https://dbi.r-dbi.org/reference/dbFetch.html) without
