...
spec_meta_arrow_params_bind <- list(
  arrow_params_bind_return_value = function(ctx, con) {
    ...
    for (placeholder_fun in placeholder_funs) {
      ...
      bind_res <- withVisible(dbBind(res, nanoarrow::as_nanoarrow_array_stream(bind_values)))
  ...
  arrow_params_bind_return_value_statement = function(ctx, con) {
    placeholder_funs <- get_placeholder_funs(ctx)
    is_null_check <- ctx$tweaks$is_null_check
  ...
  arrow_params_bind_too_many = function(ctx, con) {
    placeholder_funs <- get_placeholder_funs(ctx)
    is_null_check <- ctx$tweaks$is_null_check
    for (placeholder_fun in placeholder_funs) {
      bind_values <- 1L
      ...
      res <- dbSendQueryArrow(con, sql)
      on.exit(if (!is.null(res)) expect_error(dbClearResult(res), NA))
      expect_error(dbBind(res, nanoarrow::as_nanoarrow_array_stream(bind_values_patched)), ".*")
      expect_error(dbClearResult(res), NA)
      res <- NULL
    }
  },
  arrow_params_bind_not_enough = function(ctx, con) {
    placeholder_funs <- get_placeholder_funs(ctx)
    is_null_check <- ctx$tweaks$is_null_check
    for (placeholder_fun in placeholder_funs) {
      bind_values <- 1:2
  ...
  arrow_params_bind_wrong_name = function(ctx, con) {
  ...
  arrow_params_bind_named_param_unnamed_placeholders = function(ctx, con) {
    placeholder_funs <- get_placeholder_funs(ctx, requires_names = TRUE)
    is_null_check <- ctx$tweaks$is_null_check
    for (placeholder_fun in placeholder_funs) {
      bind_values <- 1L
  ...
  arrow_params_bind_named_param_empty_placeholders = function(ctx, con) {
    placeholder_funs <- get_placeholder_funs(ctx, requires_names = TRUE)
    is_null_check <- ctx$tweaks$is_null_check
    for (placeholder_fun in placeholder_funs) {
  ...
  arrow_params_bind_unnamed_param_named_placeholders = function(ctx, con) {
  ...
  arrow_params_bind_premature_clear = function(ctx, con) {
    placeholder_funs <- get_placeholder_funs(ctx)
    is_null_check <- ctx$tweaks$is_null_check
    for (placeholder_fun in placeholder_funs) {
      bind_values <- 1L
      ...
      res <- dbSendQueryArrow(con, sql)
      dbClearResult(res)
      expect_error(dbBind(res, nanoarrow::as_nanoarrow_array_stream(bind_values)), ".*")
    }
  },
  arrow_params_bind_multi_row = function(ctx, con) {
    placeholder_funs <- get_placeholder_funs(ctx)
    is_null_check <- ctx$tweaks$is_null_check
    for (placeholder_fun in placeholder_funs) {
  ...
  arrow_params_bind_multi_row_zero_length = function(ctx, con) {
    placeholder_funs <- get_placeholder_funs(ctx)
    is_null_check <- ctx$tweaks$is_null_check
    for (placeholder_fun in placeholder_funs) {
  ...
  arrow_params_bind_multi_row_statement = function(ctx, con) {
    placeholder_funs <- get_placeholder_funs(ctx)
    is_null_check <- ctx$tweaks$is_null_check
    allow_na_rows_affected <- ctx$tweaks$allow_na_rows_affected
    for (placeholder_fun in placeholder_funs) {
  ...
  arrow_params_bind_repeated = function(ctx, con) {
    placeholder_funs <- get_placeholder_funs(ctx)
    is_null_check <- ctx$tweaks$is_null_check
    for (placeholder_fun in placeholder_funs) {
      bind_values <- 1L
  ...
  arrow_params_bind_repeated_statement = function(ctx, con) {
    placeholder_funs <- get_placeholder_funs(ctx)
    is_null_check <- ctx$tweaks$is_null_check
    allow_na_rows_affected <- ctx$tweaks$allow_na_rows_affected
    for (placeholder_fun in placeholder_funs) {
  ...
  arrow_params_bind_repeated_untouched = function(ctx, con) {
    placeholder_funs <- get_placeholder_funs(ctx)
    is_null_check <- ctx$tweaks$is_null_check
    for (placeholder_fun in placeholder_funs) {
      bind_values <- 1L
  ...
  arrow_params_bind_repeated_untouched_statement = function(ctx, con) {
    placeholder_funs <- get_placeholder_funs(ctx)
    is_null_check <- ctx$tweaks$is_null_check
    allow_na_rows_affected <- ctx$tweaks$allow_na_rows_affected
    for (placeholder_fun in placeholder_funs) {
  ...
  arrow_params_bind_named_param_shuffle = function(ctx, con) {
    placeholder_funs <- get_placeholder_funs(ctx, requires_names = TRUE)
    is_null_check <- ctx$tweaks$is_null_check
    for (placeholder_fun in placeholder_funs) {
      ...
      res <- dbSendQueryArrow(con, sql)
      on.exit(if (!is.null(res)) expect_error(dbClearResult(res), NA))
      dbBind(res, nanoarrow::as_nanoarrow_array_stream(bind_values_patched))
      expect_error(dbClearResult(res), NA)
      res <- NULL
    }
  },
  arrow_params_bind_integer = function(ctx, con) {
    placeholder_funs <- get_placeholder_funs(ctx)
    is_null_check <- ctx$tweaks$is_null_check
    for (placeholder_fun in placeholder_funs) {
  ...
  arrow_params_bind_numeric = function(ctx, con) {
    placeholder_funs <- get_placeholder_funs(ctx)
    is_null_check <- ctx$tweaks$is_null_check
    for (placeholder_fun in placeholder_funs) {
      bind_values <- c(1.5, 2.5, 3.5, NA)
  ...
  arrow_params_bind_logical = function(ctx, con) {
    placeholder_funs <- get_placeholder_funs(ctx)
    is_null_check <- ctx$tweaks$is_null_check
    for (placeholder_fun in placeholder_funs) {
  ...
  arrow_params_bind_character = function(ctx, con) {
    placeholder_funs <- get_placeholder_funs(ctx)
    is_null_check <- ctx$tweaks$is_null_check
    for (placeholder_fun in placeholder_funs) {
  ...
  arrow_params_bind_character_escape = function(ctx, con) {
    placeholder_funs <- get_placeholder_funs(ctx)
    is_null_check <- ctx$tweaks$is_null_check
    for (placeholder_fun in placeholder_funs) {
      bind_values <- c(" ", "\n", "\r", "\b", "'", "\"", "[", "]", "\\", NA)
  ...
  arrow_params_bind_factor = function(ctx, con) {
    placeholder_funs <- get_placeholder_funs(ctx)
    is_null_check <- ctx$tweaks$is_null_check
    for (placeholder_fun in placeholder_funs) {
  ...
  arrow_params_bind_date = function(ctx, con) {
  ...
  arrow_params_bind_date_integer = function(ctx, con) {
    skip_if(!isTRUE(ctx$tweaks$date_typed))
    placeholder_funs <- get_placeholder_funs(ctx)
    is_null_check <- ctx$tweaks$is_null_check
    for (placeholder_fun in placeholder_funs) {
  ...
  arrow_params_bind_timestamp = function(ctx, con) {
  ...
  arrow_params_bind_timestamp_lt = function(ctx, con) {
    skip_if(!isTRUE(ctx$tweaks$timestamp_typed))
    placeholder_funs <- get_placeholder_funs(ctx)
    is_null_check <- ctx$tweaks$is_null_check
    for (placeholder_fun in placeholder_funs) {
  ...
  arrow_params_bind_time_seconds = function(ctx, con) {
  ...
  arrow_params_bind_time_hours = function(ctx, con) {
    skip_if(!isTRUE(ctx$tweaks$time_typed))
    placeholder_funs <- get_placeholder_funs(ctx)
    is_null_check <- ctx$tweaks$is_null_check
    for (placeholder_fun in placeholder_funs) {
  ...
  arrow_params_bind_time_minutes_integer = function(ctx, con) {
    skip_if(!isTRUE(ctx$tweaks$time_typed))
    placeholder_funs <- get_placeholder_funs(ctx)
    is_null_check <- ctx$tweaks$is_null_check
    for (placeholder_fun in placeholder_funs) {
  ...
  arrow_params_bind_blob = function(ctx, con) {
