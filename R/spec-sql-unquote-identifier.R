...
spec_sql_unquote_identifier <- list(
  ...
  #' @return
  unquote_identifier_return = function(ctx) with_connection({
  ...
  #
  unquote_identifier_vectorized = function(ctx) with_connection({
  ...
  #
  unquote_identifier_error = function(ctx) with_connection({
      #'
  ...
  #
  unquote_identifier_special = function(ctx) with_connection({
  ...
  #' quoting the string.
  unquote_identifier_simple = function(ctx) with_connection({
      simple_in <- "simple"
  ...
  unquote_identifier_table_schema = function(ctx) with_connection({
      schema_in <- "schema"
      table_in <- "table"
