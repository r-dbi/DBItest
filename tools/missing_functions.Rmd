...
## connect (8): inline? What about helper functions?
...
## get_penguins (40): inline dynamically, with factor support? Look at duckdb skips
...
## local_remove_test_table (31): inline try_silent, then inline dynamically or closure
...
## local_result (46): implement so that it's ready to be added to withr, export, inline
...
## expect_equal_arrow (8): linked to expect_equal_df
...
## expect_equal_df (86): check and understand behavior carefully, decide
...
## expect_has_class_method (1): inline
...
## trivial_statement (10): inline, simple forward to tweak
...
## get_key_methods (1): sync with dbi_generics
...
## expect_all_args_have_default_values (1): inline
...
## expect_arglist_is_empty (1): inline, same as expect_all_args_have_default_values
...
## local_connection (13): inline, after inlining connect
...
## test_data_type (2): difficult inline exercise, leading to non-DRY spec, or difficult dynamic inline. Split?
...
## test_select (1): dynamic inline, difficult
...
## test_select_with_null (17): dynamic second-order inline
...
## local_closed_connection (3): define as closure, after resolving connect()
...
## local_invalid_connection (3): define as closure, after resolving connect()
...
## expect_invisible_true (14): closure
...
## trivial_values (4): inline dynamically, easiest
...
## get_texts (13): inline dynamically, easiest
...
## test_arrow_roundtrip_one (4): inline dynamically
...
## test_table_roundtrip_one (4): inline dynamically
...
## sql_union (6): inline dynamically
...
## random_table_name (18): inline dynamically
...
## stream_frame (42): inline dynamically
...
## trivial_df (71): inline dynamically
...
## package_name (5): known at render time
...
## get_placeholder_funs (128): known at render time
...
## skip_if_not_dbitest (72): known at render time
...
# Export and fully qualify?

## check_arrow (18): linked to check_df
